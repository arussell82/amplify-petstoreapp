...
export default function PetProfile(props) {
  ...
  const buttonThreeSixFiveSixTwoSevenOneSixOnClick = useDataStoreDeleteAction({
    id: pet?.id,
    model: Pet,
    schema: schema,
  });
  return (
    ...
    >
      <Button
        ...
        children="Delete"
        onClick={() => {
          buttonThreeSixFiveSixTwoSevenOneSixOnClick();
        }}
        {...getOverrideProps(overrides, "Button36562716")}
      ></Button>
      <Image
        width="132px"
        height="132px"
      ...
      >
        <Text
          ...
          {...getOverrideProps(overrides, "Alberto Russell")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
      ...
      <Button
        ...
        variation="primary"
        children="Update"
        {...getOverrideProps(overrides, "Button36562708")}
      ></Button>
    </Flex>
  );
}
